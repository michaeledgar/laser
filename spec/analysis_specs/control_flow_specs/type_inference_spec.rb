...
EOF
    ClassRegistry['CPSim6'].singleton_class.instance_method('multiply').return_type_for_types(Utilities.type_for(ClassRegistry['CPSim6']), [], Types::NILCLASS).should == Types::UnionType.new([Types::ClassType.new('Integer', :covariant), Types::STRING])
  end
...
EOF
    ClassRegistry['CPSim7'].singleton_class.instance_method('multiply').return_type_for_types(Utilities.type_for(ClassRegistry['CPSim7']), [], Types::NILCLASS).should == Types::FLOAT
  end
end
